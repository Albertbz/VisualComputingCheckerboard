...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(1280, 720, "AR Window", nullptr, nullptr);
    ...
    // --- Cube Shader Program ---
    GLuint cubeShaderProgram = createShaderProgram(cubeVertexShaderSrc, cubeFragmentShaderSrc);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        if (found) {
            ...
            projection[2][1] = (2.0f * cy) / frameHeight - 1.0f; // Flipped for OpenGL's Y-up coord system
            ...
            model = glm::translate(model, glm::vec3(0.0125f, 0.0125f, 0.0f));
            
            // Scale down the cube
            model = glm::scale(model, glm::vec3(0.025f));

            glm::mat4 axisCorrection = glm::scale(glm::mat4(1.0f), glm::vec3(1.0f, -1.0f, -1.0f));
